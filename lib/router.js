...
Router.map(function () {
    ...
    this.route('invite', {
        ...
        waitOn: function () {
            return [Meteor.subscribe('usernamesRoles'), Meteor.subscribe('singleProduct', this.params.slug), Meteor.subscribe('productInvitations', this.params.slug)];
        },
        data: function () {
            return Products.findOne({slug: this.params.slug});
        }
    ...
    this.route('productEdit', {
        ...
        waitOn: function () {
            return [Meteor.subscribe('usernamesRoles'), Meteor.subscribe('singleProduct', this.params.slug), Meteor.subscribe('privateMessageForProduct', this.params.slug), Meteor.subscribe('productInvitations', this.params.slug)];
        },
        data: function () {
            return Products.findOne({slug: this.params.slug});
        }
